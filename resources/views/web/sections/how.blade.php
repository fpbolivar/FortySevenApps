<section id="about" class="vc_row bg-no-repeat pt-20 pb-20"
        ...
        <div class="row" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview", "animationTarget":"all-childs", "duration":"1600", "delay":"160", "easing":"easeOutQuint", "initValues":{"translateY": 100, "opacity":0}, "animations":{"translateY": 0, "opacity":1}}'>
            <div class="lqd-column col-md-12 mb-60">
                <header class="fancy-title">
                    <h6 class="text-uppercase">How it works</h6>
                    <h2><strong>Simple process</strong> to start</h2>
                </header>
            ...
            <div class="lqd-column col-md-4">
                ...
                <div
                    class="iconbox text-left iconbox-xl iconbox-icon-image iconbox-shadow border-radius-5 px-5 pt-40 pb-55 mr-md-4">
                    <div class="iconbox-icon-wrap">
                        <span class="iconbox-icon-container mb-35">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="80" height="80.16" viewBox="0 0 80 80.16">
                                <defs xmlns="http://www.w3.org/2000/svg">
                                    <linearGradient gradientUnits="userSpaceOnUse" id="grad231243" x1="0%"
                                        y1="0%" x2="0%" y2="100%">
                                ...
                                <defs>
                                    <filter id="filter-seo-icon-1" x="427.5" y="1555" width="80"
                                        height="80.16" filterUnits="userSpaceOnUse">
                                        <feImage preserveAspectRatio="none" x="427.5" y="1555" width="80"
                                            height="80.16" result="image"
                                ...
                                <path fill="#fd5c4c" filter="url(#filter-seo-icon-1)"
                                    ...
                                    transform="translate(-427.5 -1555)"></path>
                            </svg>
                        </span>
                    </div><!-- /.iconbox-icon-wrap -->
                    <div class="contents">
                        <h3>Idea &amp; Concept</h3>
                        <p><span style="font-size: 18px;line-height: 30px">Introduction and kick-off meeting checklist.
                                Lorem ispumdolor sit amet.</span></p>
                    </div><!-- /.contants -->
                </div><!-- /.iconbox -->
            ...
            <div class="lqd-column col-md-4">
                ...
                <div
                    class="iconbox text-left iconbox-xl iconbox-icon-image iconbox-shadow border-radius-5 px-5 pt-40 pb-55 mx-md-2">
                    <div class="iconbox-icon-wrap">
                        <span class="iconbox-icon-container mb-45">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="79.5" height="70.625" viewBox="0 0 79.5 70.625">
                                <defs xmlns="http://www.w3.org/2000/svg">
                                    <linearGradient gradientUnits="userSpaceOnUse" id="grad797996" x1="0%"
                                        y1="0%" x2="0%" y2="100%">
                                        <stop offset="0%" stop-color="#f42958"></stop>
                                        <stop offset="100%" stop-color="#f42958"></stop>
                                    </linearGradient>
                                ...
                                <defs>
                                    <filter id="filter-seo-icon-2" x="-0.5" y="0.688" width="80"
                                        height="70.625" filterUnits="userSpaceOnUse">
                                        <feImage preserveAspectRatio="none" x="-0.5" y="0.6875" width="80"
                                            height="70.625" result="image"
                                ...
                                <path filter="url(#filter-seo-icon-2)"
                                    ...
                                    transform="translate(0 -0.688)"></path>
                            </svg>
                        </span>
                    </div><!-- /.iconbox-icon-wrap -->
                    <div class="contents">
            ...
            <div class="lqd-column col-md-4">
                ...
                <div
                    class="iconbox text-left iconbox-xl iconbox-icon-image iconbox-shadow border-radius-5 px-5 pt-40 pb-55 ml-md-4">
                    <div class="iconbox-icon-wrap">
                        <span class="iconbox-icon-container mb-45">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="70.625" height="70.781" viewBox="0 0 70.625 70.781">
                                <defs xmlns="http://www.w3.org/2000/svg">
                                    <linearGradient gradientUnits="userSpaceOnUse" id="grad51784" x1="0%"
                                        y1="0%" x2="0%" y2="100%">
                                        <stop offset="0%" stop-color="#f42958"></stop>
                                        <stop offset="100%" stop-color="#f42958"></stop>
                                    </linearGradient>
                                ...
                                <defs>
                                    <filter id="filter-seo-icon-3" x="0.688" y="0.844" width="70.625"
                                        height="70.781" filterUnits="userSpaceOnUse">
                                        <feImage preserveAspectRatio="none" x="0.6875" y="0.84375"
                                            width="70.625" height="70.781" result="image"
                                ...
                                <path filter="url(#filter-seo-icon-3)"
                                    ...
                                    transform="translate(-0.688 -0.844)"></path>
                            </svg>
                        </span>
                    </div><!-- /.iconbox-icon-wrap -->
                    <div class="contents">
                        <h3>Support &amp; Secure</h3>
                        <p><span style="font-size: 18px;line-height: 30px">Introduction and kick-off meeting checklist.
                                Lorem ispumdolor sit amet.</span></p>
                    </div><!-- /.contants -->
                </div><!-- /.iconbox -->
