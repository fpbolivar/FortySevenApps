                            ...
                            <form id="validateForm" action="{{route('admin.app.update',[$edit->id])}}" method="POST" enctype='multipart/form-data' >
                            	...
                            	<div class="row multipleImages">
                                    ...
                                    <div class="form-group form-float col-md-6 col-sm-12">
                                        ...
                                        <input type="number" min="0" max="5" class="form-control" placeholder="Ratings" name="ratings" value="{{old('ratings',$edit->ratings)}}">
                                    ...
                                    <div class="form-group form-float col-md-4 col-sm-12">
                                        ...
                                        <input type="number" min="0" class="form-control input-numeric" placeholder="No Of Reviews" name="no_of_reviews" value="{{old('no_of_reviews',$edit->no_of_reviews)}}">
                                    ...
                                    <div class="form-group form-float col-md-4 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Play Store Link" name="play_store_link" value="{{old('play_store_link',$edit->play_store_link)}}">
        ...
        $(document).ready(function() {
            ...
            $("#addImage").on("click", function() {
                $(".multipleImages").append(
                    "<div class='form-group float-left form-float col-md-3 col-sm-12 image '><a class='btn bg-danger btn-sm absolute text-white delete-image delete_Data delete-absolute'>Delete</a><input name='images[]' type='file' class='dropifyMultiple' data-default-file='' data-allowed-file-extensions='jpeg jpg png'></div>"
                );
