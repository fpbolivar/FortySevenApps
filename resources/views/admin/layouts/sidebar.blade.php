...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="open_top"><a  class="universalClickEvent" data-title="Logout" data-submit="Logout" data-body="Are you sure you want to logout ?" data-url="{{route('admin.logout')}}"><i class="zmdi zmdi-power"></i><span>Logout</span></a></li>
        </ul>
    </div>
</aside>
